...
export const listarUsuariosLogados = async (req, res) => {
  try {
    ...
    }, "Usuários logados recuperados com sucesso", 200);
  } catch (error) {
...
export const listarTodosUsuariosComCredenciais = async (req, res) => {
  try {
    ...
    return ApiResponse.success(res, {
      ...
      usuarios: usuarios
    }, "Usuários listados (endpoint sensível)", 200);
  } catch (error) {
...
export const solicitarRecuperacaoSenha = async (req, res) => {
  try {
    ...
    if (!usuario) {
      ...
      return ApiResponse.success(res, { status: 'enviado' }, "Se o email existe, um link de reset foi enviado", 200);
    }
    ...
    }, "Email de recuperação enviado (em produção)", 200);
  } catch (error) {
...
/**
    ...
    return ApiResponse.success(res, { status: 'sucesso' }, "Senha atualizada com sucesso", 200);
  } catch (error) {
...
export const mudarSenha = async (req, res) => {
  try {
    ...
    // Valida senha atual
    const senhaCorreta = await bcrypt.compare(senhaAtualValidation.value, usuario.senha);
    if (!senhaCorreta) {
      return ApiResponse.unauthorized(res, "Senha atual incorreta");
    }

    // Hash nova senha
    const novoHash = await bcrypt.hash(novaSenhaValidation.value, 10);
    ...
    return ApiResponse.success(res, { status: 'sucesso' }, "Senha alterada com sucesso", 200);
  } catch (error) {
...
export const obterMeuPerfil = async (req, res) => {
  try {
    ...
    return ApiResponse.success(res, { perfil: usuario }, "Dados do perfil carregados com sucesso", 200);
  } catch (error) {
...
export const minhasSessoes = async (req, res) => {
  try {
    ...
    }, "Sessões recuperadas com sucesso", 200);
  } catch (error) {
...
export const logoutDaSessao = async (req, res) => {
  try {
    ...
    return ApiResponse.success(res, { status: 'sucesso' }, "Sessão encerrada com sucesso", 200);
  } catch (error) {
...
export const logoutGlobal = async (req, res) => {
  try {
    ...
    return ApiResponse.success(res, {
      ...
      status: 'sucesso'
    }, "Logout de todas as sessões realizado com sucesso", 200);
  } catch (error) {
